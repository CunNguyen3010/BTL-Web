...
import "../style/CreatePostalItems.css";

function CreatePostalItems() {
  // Người gửi
            ...
            <div className="column">
              ...
              <div className="text-center">
                <div className="btn-search">
                  <button type="submit" class="btn" onClick={handleCreatePostalItems}>
...
export default CreatePostalItems;
